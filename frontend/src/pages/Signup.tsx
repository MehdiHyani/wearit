    ...
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div>
                ...
                <div className="md:pt-2 md:pl-20">
                    <img className="mt-10 ml-10 h-12 sm:mb-20" src={logo}/>
                </div>
                ...
                <div className="flex flex-col centered">
                    ...
                    <form className='mt-10 gap-5' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input {...register('email', { required: 'Required E-mail' })}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="Enter your email address"/>
                        <p className='mt-2 mb-5 text-red-500 text-xs'>{errors.email?.message}</p>
